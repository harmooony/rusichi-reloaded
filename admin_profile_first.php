  ...
  <main>
    ...
    <div class="container">
      <div class="profile_container">
        <div class="profile_green">
          <div class="profile_card">
            ...
            <div class="profile_card_names">
              <p class="profile_rank">Администратор 1-го уровня</p>
        ...
        <div>
          <p class="admin_label">Создание логинов для курсантов</p>
          <div class="admin_create_container">
            <form action="php_scripts/registration.php" method="post" class="admin_create">
              <p class="admin_p">Логин</p>
              <input name="login" type="text" class="admin_input" list="login">
              <p class="admin_p">Пароль</p>
              <input name="password" type="text" class="admin_input" list="login">
              <input type="submit" value="Создать аккаунт" class="admin_button"></input>
              <p>
                <?php
                if ($_SESSION['message']) {
        ...
        <div>
          <p class="admin_label notlast">Добавление в команду</p>
          <div class="admin_create_container">
            <form action="php_scripts/add_team.php" method="post" class="admin_create">
              <p class="admin_p">Логин</p>
              <input name="login" type="text" class="admin_input" list="login">
              <p class="admin_p">Команда</p>
              <input name="team" type="text" class="admin_input" list="teams">
              <input type="submit" value="Добавить в команду" class="admin_button"></input>
            </form>
          </div>
        </div>

        <button onclick="window.location.href = 'logs.php'" class="admin_exitbutton">Логи</button>
